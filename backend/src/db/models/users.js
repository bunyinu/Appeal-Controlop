...
/// loop through entities and it's fields, and if ref === current e[name] and create relation has many on parent entity
    ...
    db.users.hasMany(db.appeal_drafts, {
      as: 'appeal_drafts_author_user',
      foreignKey: {
          name: 'author_userId',
      },
      constraints: false,
