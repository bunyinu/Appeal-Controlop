                        ...
                        <div className={`flex rounded  dark:bg-dark-900  border  border-stone-300  items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                ...
                                <p className={'line-clamp-2'}>{ dataFormatter.usersOneListFormatter(item.uploaded_by_user) }</p>
                            </div>
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs   text-gray-500 '}>IsConfidential</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.booleanFormatter(item.is_confidential) }</p>
                            </div>
