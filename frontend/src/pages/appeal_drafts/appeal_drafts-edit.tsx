...
const EditAppeal_draftsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{getPageTitle('Edit appeal_drafts')}</title>
      </Head>
      <SectionMain>
...
EditAppeal_draftsPage.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
...
export default EditAppeal_draftsPage
