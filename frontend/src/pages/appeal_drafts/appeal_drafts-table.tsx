...
const Appeal_draftsTablesPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{getPageTitle('Appeal_drafts')}</title>
      </Head>
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title="Appeal_drafts" main>
        {''}
        </SectionTitleLineWithButton>
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          
            {hasCreatePermission && <BaseButton className={'mr-3'} href={'/appeal_drafts/appeal_drafts-new'} color='info' label='New Item'/>}
