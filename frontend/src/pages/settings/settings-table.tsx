...
const SettingsTablesPage = () => {
  ...
  const [filters] = useState([{label: 'Key', title: 'key'},{label: 'Value', title: 'value'},{label: 'Description', title: 'description'},
          ...
          {label: 'ValueType', title: 'value_type', type: 'enum', options: ['string','number','boolean','json']},
  ]);
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title="Settings" main>
        {''}
        </SectionTitleLineWithButton>
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          
            {hasCreatePermission && <BaseButton className={'mr-3'} href={'/settings/settings-new'} color='info' label='New Item'/>}
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <div id='delete-rows-button'></div>
              ...
              <Link href={'/settings/settings-list'}>
