            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Case</p>
                        ...
                        <p>{notes?.case?.case_number ?? 'No data'}</p>
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>Author</p>
                        ...
                        <p>{notes?.author_user?.firstName ?? 'No data'}</p>
                ...
                <div className={'mb-4'}>
                  ...
                  {notes.body
                    ? <p dangerouslySetInnerHTML={{__html: notes.body}}/>
                    : <p>No data</p>
                  }
                </div>
                ...
                <FormField label='IsPrivate'>
                    <SwitchField
                      field={{name: 'is_private', value: notes?.is_private}}
                ...
                <div className={'mb-4'}>
                    <p className={'block font-bold mb-2'}>NoteType</p>
                    <p>{notes?.note_type ?? 'No data'}</p>
                </div>
