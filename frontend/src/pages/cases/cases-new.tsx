...
import { create } from '../../stores/cases/casesSlice'
...
const CasesNew = () => {
  ...
  <FormField label="Payer" labelFor="payer">
      <Field name="payer" id="payer" component={SelectField} options={[]} itemRef={'payers'}></Field>
  </FormField>
  ...
  <FormField label="Owner" labelFor="owner_user">
      <Field name="owner_user" id="owner_user" component={SelectField} options={[]} itemRef={'users'}></Field>
  </FormField>
  ...
  >
      <Field
          type="datetime-local"
          name="patient_dob"
          placeholder="PatientDateofBirth"
      />
  </FormField>
...
CasesNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated
